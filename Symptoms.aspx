...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:table runat="server" id="HealthInfo">      
     <asp:TableRow  >
        ...
        <h6>Por favor informe si usted o algún miembro de sus familia, que viva con usted, ha presentado alguno de los siguientes síntomas* en las últimas 24 horas.<br />
            ...
            *Fuente CDC<br />
            Si su respuesta es afirmativa, por favor especifique. La información que usted suministre, solamente será conocida por el área de salud ocupacional. <br />
            ...
            <h6>Please inform if you or any of your family members, that live with you, have presented any of the following symptoms* in the last 24 hours.  <br />
             *Source: CDC <br />
             Fever (equal to or greater than 38°C, Dry cough, Fatigue or difficulty breathing,  Loss of smell and taste<br />
            If your answer is affirmative, please specify. The information you provide will only be known by the Occupational Health area. <br />
            In case of presenting at least one of these symptoms, please inform your medical service, EPS or Supplemental Medicine Provider<br /></h6>
            <br />
         </asp:TableCell>
        </asp:TableRow>       
    </asp:table>
    <div class="row">
        <div class="col-md-8">
            <h1><asp:Label ID="Label2" runat="server"  Text="Reporte Sintomas para hoy? / Symptoms Report for today?" /></h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <h1><asp:Label ID="Label3" runat="server"  Text="Información de Contactos y Viajes? / Contact & Travels information?" /></h1>
    ...
    <div class="row">
        <div class="col-md-8">
            <h6><asp:Label ID="Label4" runat="server"  Text=" En caso afirmativo, especifique el parentesco y los sintomas del miembro de su familia/In case yes, please specify what the relationship and symptoms " /></h6>
    ...
    <br />
     ...
     <telerik:RadPageView runat="server" ID="results" >
        ...
        <h2> <asp:TextBox ID="TextAccessName" runat="server"  Visible="true"  BackColor="#5cb85c" BorderStyle="None" Width="100%"></asp:TextBox></h2>          
        <h2> <asp:TextBox ID="AccessDate" runat="server"  Visible="true"  BackColor="#5cb85c" BorderStyle="None" Width="100%" ></asp:TextBox></h2> 
     ...
     <telerik:RadPageView runat="server" ID="nonresults"  >        
        <div class="alertmsg">
        <h1>Access Denied</h1>  
        <h2> <asp:TextBox ID="TextDeniedName" runat="server"  Visible="true"  BackColor="Crimson" BorderStyle="None" Width="100%"></asp:TextBox></h2>    
        <h2> <asp:TextBox ID="DeniedDate" runat="server"  Visible="true"  BackColor="Crimson" BorderStyle="None" Width="100%" ></asp:TextBox></h2> 
